...
- [Functions](#functions)
    ...
    - [PERCENTILE(field, percentileValue)](#percentilefield)
    - [SUM(field)](#sumfield)
    - [COUNT(field), COUNT(*), COUNT(DISTINCT field)](#countfield)
    - [TOP(field, n)](#topfield)
    ...
    - [CONDITION(function, condition)](#conditionfunction)
